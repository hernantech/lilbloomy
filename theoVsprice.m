...
function array = theoVsprice(data, calorputs)
...
%sometimes afterhours the price shown in yahoo finance is zero, must
%account for this
...
%can fix the indexing issue with limiting the number of entries. Will do
